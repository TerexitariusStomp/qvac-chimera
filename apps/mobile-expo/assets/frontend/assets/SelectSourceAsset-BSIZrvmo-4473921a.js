import{b as o,j as e,r as d,cc as f}from"./index-f3d2c4df.js";import{n as j}from"./ScreenLayout-Ce16-u0i-9f2d120d.js";import{C as k}from"./chevron-down-a11390c3.js";const T=({currency:i="usd",value:a,onChange:n,inputMode:s="decimal",autoFocus:c})=>{var v;let[u,x]=d.useState("0"),h=d.useRef(null),p=a??u,g=((v=f[i])==null?void 0:v.symbol)??"$",b=d.useCallback(t=>{let r=t.target.value,l=(r=r.replace(/[^\d.]/g,"")).split(".");l.length>2&&(r=l[0]+"."+l.slice(1).join("")),l.length===2&&l[1].length>2&&(r=`${l[0]}.${l[1].slice(0,2)}`),r.length>1&&r[0]==="0"&&r[1]!=="."&&(r=r.slice(1)),(r===""||r===".")&&(r="0"),n?n(r):x(r)},[n]),w=d.useCallback(t=>{!(["Delete","Backspace","Tab","Escape","Enter",".","ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key)||(t.ctrlKey||t.metaKey)&&["a","c","v","x"].includes(t.key.toLowerCase()))&&(t.key>="0"&&t.key<="9"||t.preventDefault())},[]),m=d.useMemo(()=>(p.includes("."),p),[p]);return e.jsxs(C,{onClick:()=>{var t;return(t=h.current)==null?void 0:t.focus()},children:[e.jsx(y,{children:g}),m,e.jsx("input",{ref:h,type:"text",inputMode:s,value:m,onChange:b,onKeyDown:w,autoFocus:c,placeholder:"0",style:{width:1,height:"1rem",opacity:0,alignSelf:"center",fontSize:"1rem"}}),e.jsx(y,{style:{opacity:0},children:g})]})},q=({selectedAsset:i,onEditSourceAsset:a})=>{let{icon:n}=f[i];return e.jsxs(A,{onClick:a,children:[e.jsx(S,{children:n}),e.jsx(z,{children:i.toLocaleUpperCase()}),e.jsx(E,{children:e.jsx(k,{})})]})};let C=o.span`
