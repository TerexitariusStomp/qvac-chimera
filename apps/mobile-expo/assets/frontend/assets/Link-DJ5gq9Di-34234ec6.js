import{b as s,j as c}from"./index-f3d2c4df.js";let l=s.a`
  && {
...
`;const p=({size:r="md",variant:e="navigation",disabled:n=!1,as:a,children:t,onClick:o,...d})=>c.jsx(l,{as:a,$size:r,$variant:e,$disabled:n,onClick:i=>{n?i.preventDefault():o==null||o(i)},...d,children:t});export{p as n};
